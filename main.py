...
for i in range(4):
    x = i * 10
    y = min_obs_pos_y + (i * 10)
    width = 50
    height = 120 - (i * 10)
    Obstacle_collision.append(Obstacle(x, y, width, height))

for x in range(50, 60, 10):
    Obstacle_collision.append(Obstacle(x, min_obs_pos_y + 40, 500, 80))
...
#Rendu graphique
    ...
    for obstacle in Obstacle_collision:
        obstacle.draw(game_display, (255, 255, 255))  # Draw each obstacle
    ...
    charge1 = Bar(25, 85, 250, 20, player1.charge_max, player1.charge, "ult")
    charge1.draw(game_display)
    charge2 = Bar(game_display.get_width() - 275, 85, 250, 20, player2.charge_max, player2.charge, "ult")
    charge2.draw(game_display)
